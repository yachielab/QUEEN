...
- `supfeature` parameter is added for the operational functions. It help users add annotations for the QUEEN object generated by the operational functions.  
